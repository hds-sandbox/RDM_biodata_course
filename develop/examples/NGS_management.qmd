...
1. Next Generation Sequencing data types and metadata
2. Best practices for software and code management
...
- Register your code in a research software registry and include a clear and accessible software usage license: enabling other researcher to discover and reuse software packages (alongside a metadata). More recommendations [here](https://fair-software.eu/recommendations/registry/). 
...
Find more resources in [Berkeley Library website](https://guides.lib.berkeley.edu/how-to-write-good-documentation)
:::

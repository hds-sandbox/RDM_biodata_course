...
:::{.callout-definition}
# Visit your institution's DMP tools and other online services  
...
9. **Horizon Europe and ERC templates**: projects funded in the Horizon Europe framework program must prepare and submit a data management plan as deliverable according to the details described in the respective grant agreement.
:::

#### DMPonline

Researchers at Danish research institutions are advised to use [DMPOnline]( https://dmp.deic.dk), a tool for creating, sharing, and reviewing DMPs. It has been developed by the Digital Curation Centre and made available by [Danish e-infrastructure Cooperation (DeiC)](https://www.deic.dk/) and jointly administered by the Royal Danish Library and DTU Library.

Follow this [instructions](https://www.deic.dk/en/data-management-plans-with-deic-dmp) to get an account. It offers several DMP templates with guidelines that are provided (generic and not specific to Life Sciences). 
...
The DMP template we offer has been prefilled using [DMPonline](https://dmponline.deic.dk/) and the Horizon Europe guidelines by one of us. It contains the necessary information and common practices (for example, the repositories, metadata, etc.). We used the Horizon Europe template as focuses more on digital data. 
:::

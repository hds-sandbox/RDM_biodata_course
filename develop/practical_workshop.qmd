...
- Option a. Install [Quarto](https://quarto.org/docs/get-started/). We recommend Quarto as is easy to use and provides a native support for notebooks (R Markdown and Jupyter Notebooks). No extensions or dependencies needed. 
...
- **documents**: folder containing word documents, slides or pdfs related to the project, such as explanations of the data or project, papers, etc. It also contains your [Data Management Plan](./02_DMP.qmd).

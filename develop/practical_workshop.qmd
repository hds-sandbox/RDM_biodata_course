...
1. Go to our [Cookiecutter template](https://github.com/hds-sandbox/cookiecutter-template) and click on the **Fork** button at the top-right corner of the repository page to create a copy of the repository on your own GitHub account or organization.
...
To maximize the usefulness of metadata, aim to use controlled vocabularies across all fields. Read more about data documentation and find ontology services examples in [lesson 4](https://hds-sandbox.github.io/RDM_biodata_course/develop/04_metadata.html#controlled-vocabularies-and-ontologies). We encourage you to begin implementing them systematically on your own (under the "sources" section, you will find some helpful links to guide you putting them in practice). 

If you work with NGS data, check out [this](https://hds-sandbox.github.io/RDM_biodata_course/develop/examples/NGS_metadata.html) recommendations and examples of metadata for samples, projects and datasets. 
:::
...
As discussed in [lesson 3](https://hds-sandbox.github.io/RDM_biodata_course/develop/03_DOD.html#naming-conventions), consistent naming conventions are key for interpreting, comparing, and reproducing findings in scientific research. Standardized naming helps organize and retrieve data or results, allowing researchers to locate and compare similar types of data within or across large datasets. 

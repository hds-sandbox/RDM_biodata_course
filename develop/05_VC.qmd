...
We provide an example setting up Git, MkDocs, and a GitHub account, enabling you to replicate the process independently! (see *Exercise 5* in the [practical workshop](./practical_workshop.qmd))
